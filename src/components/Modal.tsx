...
//   return createPortal(
//     <div
//       className="fixed inset-0 z-50 grid place-items-center bg-slate-900/60 p-5"
//       role="presentation"
//     >
//       <div
...
//             <h3 className="m-0" id={titleId}>
//               {title}
//             </h3>
//             <button
//               className="rounded-[14px] border-0 bg-slate-950 px-3.5 py-2.5 text-white disabled:opacity-55"
//               type="button"
