...
function Preview({
  ...
  return (
    <div className='flex h-full flex-col items-center justify-center border-2 border-dashed border-grey-04 bg-grey-02 p-6 text-center text-text-secondary'>
...
export function FeatureSection() {
  ...
  return (
    <section
      id='features'
      className='mx-auto max-w-6xl border-b border-grey-02 px-5 py-20 lg:px-8 lg:py-28'
    >
      <div className='mb-10'>
