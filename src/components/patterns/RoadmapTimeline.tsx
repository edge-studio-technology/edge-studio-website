        ...
        >
          ...
          <div className="pb-5">
            ...
            >
              ...
              <span
                className={`justify-self-start rounded-full border px-4 py-1.5 text-sm font-semibold uppercase tracking-[0.12em] sm:justify-self-end ${item.state === 'active' ? 'border-core-white/50 bg-core-white/15 text-core-white' : 'border-grey-03 text-text-secondary'}`}
              >
                {item.phase}
              </span>
            </motion.div>
