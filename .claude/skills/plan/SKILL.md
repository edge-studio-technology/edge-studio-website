...
A task is a good candidate for a closed-loop plan when it repeats, has a deterministic definition of done, and a separate checker can verify the result. Use `/closed-loop` for the execution phase after the plan is approved.
