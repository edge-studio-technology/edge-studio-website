---
name: domain-check
description: Use when a change touches sensitive areas defined in .claude/rules/domain-rules.md. Flags domain-rule implications before code is written.
---
...
1. Read `.claude/rules/domain-rules.md` in full.
