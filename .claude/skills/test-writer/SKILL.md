...
Load `.claude/rules/testing.md` before writing anything.

## Execution Contract

- MUST load `.claude/rules/testing.md` before writing any test
...
3. Place tests in the correct folder per `.claude/rules/testing.md`
