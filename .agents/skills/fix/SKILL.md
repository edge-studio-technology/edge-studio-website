...
5. Write a failing test first if the bug is unit-testable — place it in the correct folder per `.agents/rules/testing.md`
...
12. Run `/skill:verify` to do a final checker pass before declaring completion
