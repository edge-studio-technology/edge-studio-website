...
Load and apply `.agents/rules/domain-rules.md` before doing anything else — it's the source of truth for data-handling rules.
...
- MUST load `.agents/rules/domain-rules.md` before reviewing
