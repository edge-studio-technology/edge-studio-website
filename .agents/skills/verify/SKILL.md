---
name: verify
description: Checker skill for the closed-loop workflow. Prove whether a change satisfies its goal using the diff and gate output.
---
...
Use after a maker skill (`/skill:fix`, `/skill:feature`, direct edits) has attempted to satisfy a goal that was defined in a plan or spec.
