...
- **Maker**: implements the change. This is you when you invoke `/skill:fix`, `/skill:feature`, or work directly.
- **Checker**: verifies the diff and gate output against the goal. Use `/skill:verify` for this.
